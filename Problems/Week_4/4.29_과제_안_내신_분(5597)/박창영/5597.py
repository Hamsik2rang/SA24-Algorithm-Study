...
#---------------------------------------------------------------------
# 학생 번호 1~30번에 대한 리스트 studentNum 선언
# for문으로 리스트에 1~30까지 넣기
studentNum = []
for i in range(1, 31) :
    studentNum.append(i)

# 값을 28번 입력받아 입력 값에 대해서 studentNum 값과 동일한 것은 remove 시킴
for i in range(1, 29) :
    # print("{0}번째로 출석한 학생의 번호 입력 : ".format(i),end="")
    inputNum = int(input())
    studentNum.remove(inputNum)
